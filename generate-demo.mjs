...
// 渲染完整 HTML
function generateHTML(ast, cssVariables) {
...
// 生成 HTML
const html = generateHTML(ast, cssVariables);
console.log("\n=== 生成的 HTML ===");
console.log(html);
